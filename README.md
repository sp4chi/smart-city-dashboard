...
- **Tertiary** _(future)_: Citizens submitting incident reports via a public-facing form
...
See [`docs/SYSTEM_DESIGN_NOTES.md`](docs/SYSTEM_DESIGN_NOTES.md) for _why_ each of these was chosen and general system design concepts.
...
### Sanity Check Command to match folder Structure

```bash
find {folder_you_want_to_search_inside} -name "*.py" | sort
```
...
_This project was built as a solo effort. See `DEVELOPMENT_LOG.md` for design decisions, trade-offs, and problems encountered along the way._
